    ...
    public partial class Newmember : Form
    {
        ...
        private void savebtn_Click(object sender, EventArgs e)
        {
           ...
           //Int64 Mno = Convert.ToInt64(mno.Text);
            ...
            String Timing = timing.Text;
            SqlConnection con =new SqlConnection();
            con.ConnectionString = "data source=DRAGEN94; database=gym; integrated security = True";
            SqlCommand cmd = new SqlCommand();
            cmd.Connection = con;
            cmd.CommandText="insert into Newmember1(fname,mname,lname,mno,address,email,gender,dob,doj,timing) values ('"+Fname+"','"+ Mname + "','"+Lname+"',"+Mno + ",'"+Address+"','"+Email + "','"+gender+"','"+dob+"','"+doj + "','"+Timing+"')";
